...
CFRADAR_ENABLED = config("CFRADAR_ENABLED", cast=bool, default=False)
CFRADAR_URL = config("CFRADAR_URL", default="https://api.cloudflare.com/client/v4/radar/")
CFRADAR_API_KEY = config("CFRADAR_API_KEY", cast=Secret, default="")
